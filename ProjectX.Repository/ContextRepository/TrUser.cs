...
namespace ProjectX.Repository.ContextRepository
{
    public partial class TrUser
    {
        public TrUser()
        {
            TrPrepaidAccounts = new HashSet<TrPrepaidAccount>();
        }
        ...
        public bool? UAgentsView { get; set; }
        public bool? UPrepaidAccount { get; set; }

        public virtual TrCurrencyRate? UCurrencyNavigation { get; set; }
        public virtual ICollection<TrPrepaidAccount> TrPrepaidAccounts { get; set; }
    }
}
