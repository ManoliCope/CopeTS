...
$(document).ready(function () {
    ...
    */
    $("#mobmenu").find('a').click(function () {
        $(this).closest('.menu').find(".menu_close_container").click()
    });
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            setTimeout(function () {
                ...
                $("#datepick").val("")
                $("#patientcomments").val("")
                $(".appointmentlbl").removeAttr("hidden")
