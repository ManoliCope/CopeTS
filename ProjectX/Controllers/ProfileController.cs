...
namespace ProjectX.Controllers
{
    public class ProfileController : Controller
    {
        ...
        public ProfileController(IHttpContextAccessor httpContextAccessor, IOptions<CcAppSettings> appIdentitySettingsAccessor, IProfileBusiness profileBusiness, IGeneralBusiness generalBusiness, IWebHostEnvironment env)
        {
