...
namespace ProjectX.Controllers
{
    public class BenefitController : Controller
    {
        ...
        public BenefitController(IHttpContextAccessor httpContextAccessor, IOptions<CcAppSettings> appIdentitySettingsAccessor, IProfileBusiness profileBusiness, IGeneralBusiness generalBusiness, IWebHostEnvironment env)
        {
