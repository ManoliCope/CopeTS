...
namespace ProjectX.Controllers
{
    public class ZoneController : Controller
    {
        ...
        public ZoneController(IHttpContextAccessor httpContextAccessor, IOptions<CcAppSettings> appIdentitySettingsAccessor, IProfileBusiness profileBusiness, IGeneralBusiness generalBusiness, IWebHostEnvironment env)
        {
